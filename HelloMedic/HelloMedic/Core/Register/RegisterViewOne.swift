...
class RegisterViewOne: UIViewController{
    ...
    func connexionUI(){
        ...
        NSLayoutConstraint.activate(
            [enteremail.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 50),
            ...
            enterpassword.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 20),
            ...
            loginButton.topAnchor.constraint(equalTo:loginButton.bottomAnchor, constant: 20),
